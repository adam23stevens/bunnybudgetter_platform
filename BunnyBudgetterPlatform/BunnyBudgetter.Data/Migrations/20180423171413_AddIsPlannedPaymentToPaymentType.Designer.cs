...
namespace BunnyBudgetter.Data.Migrations
{
    ...
    [Migration("20180423171413_AddIsPlannedPaymentToPaymentType")]
    partial class AddIsPlannedPaymentToPaymentType
    {
            ...
            modelBuilder.Entity("BunnyBudgetter.Data.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("BunnyBudgetter.Data.Entities.PlannedPayment", "PlannedPayment")
                        .WithMany("Payments")
